...
class Booking
{
     ...
     * @Assert\GreaterThan("today", message = "La date d'arrivée soit être utlérieure à la date d'aujourd'hui", groups={"front"}    )
     */
    private $startDate;
     ...
     * @Assert\GreaterThan(propertyPath ="startDate", message = "La date de départ soit être utlérieure à la date d'arrivée")
     */
    private $endDate;
    ...
    public function isBookableDates(){
        ...
        //$days = Tableau qui contient des chaînes de caractères de mes journées.
